                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="email" name="emailRecipient" id="emailRecipient" class="form-control" placeholder="Odbiorca">
                            </div>

                            <div class="form-group">
                                <label for="emailSubject">Temat </label>
                                <input type="text" name="emailSubject" id="emailSubject" class="form-control" placeholder="Temat">
                            </div>

                            <div class="form-group">
                                <label for="emailBody">Wiadomość </label>
                                <textarea name="emailBody" id="emailBody" class="form-control" placeholder="Wiadomość"></textarea>
                            </div>
